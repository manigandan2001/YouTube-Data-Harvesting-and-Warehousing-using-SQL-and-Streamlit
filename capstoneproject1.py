...
API_key = "AIzaSyBsPHylbGsjuyzDqOPkljnhdcNQo-gbiKg"
...
sql_engine = create_engine('mysql+pymysql://root:Digi08%40Life@localhost:3306/youtubedata')
...
def c_details(video_ids): #function to get 10 comments or less from each video
    comment_details = []
    for video_id in video_ids:
...
def scrape_and_store(channel_id):
    ...
    comment_info = c_details([video['video_id'] for video in videos_info])
...
img = Image.open("/Users/sanjay/Downloads/youtube-player-icon-with-flat-design/330685-P9SESK-66.jpg")
